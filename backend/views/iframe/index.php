            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title clearfix">
                    <div class="row pull-left col-md-6">
	                    <div class="col-md-3"><a href="<? $rl=explode('?', Yii::$app->request->getUrl()); echo $rl[0] ?>/add?hide_menu" class="btn btn-info pull-left"><?= $lang->add_button ?></a></div>
	                    <div class="col-md-9">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tr class="gradeX">
                                ...
                                <td style="width: 100px">
                                    <a class="btn btn-info" href="<? $url=explode('?', Yii::$app->request->getUrl()); echo $url[0]; ?>/edit/<?= $line['id'] ?>?hide_menu"><i class="fa fa-pencil"></i></a>
